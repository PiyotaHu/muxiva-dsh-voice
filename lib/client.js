window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function VoiceButton({ session, controller }) {
      ...
      return React.createElement('div', { className: 'mxv-voice', 'data-phase': state.phase, 'data-active': active },
        React.createElement('div', { className: 'mxv-voice__stage' },
          ...
          React.createElement('div', { className: 'mxv-voice__copy', 'aria-live': 'polite' },
            ...
            React.createElement('div', { className: 'mxv-voice__status', role: state.phase === 'error' ? 'alert' : undefined }, labels[state.phase] || state.phase),
            React.createElement('div', { className: 'mxv-voice__hint' }, hints[state.phase] || ''))))
    }
